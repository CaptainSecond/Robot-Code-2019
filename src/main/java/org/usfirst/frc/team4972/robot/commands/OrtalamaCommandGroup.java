...
public class OrtalamaCommandGroup extends CommandGroup {
    ...
    public OrtalamaCommandGroup(/*int setPoint */) {
        // Add Commands here:
        ...
        // addSequential(new UltrasonicDriveCommand(35));
        // addParallel(new ReadFromArdunioCommand());
        // addParallel(new OrtalamaCommand());
        // addSequential(new UltrasonicDriveCommand(26));
      //  addParallel(new SetAsansorCommand(setPoint));
    }
